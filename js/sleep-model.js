 ...
 *
 * Every figure here is a LENGTH in minutes, never a clock time. Clock times
 * belong to the family: night start and night end come from Settings, and the
 * app works bedtime out from those. `hasBedtime` only says whether a settled
 * bedtime means anything at this age. Bands are [from, to) in whole months.
 *
 ...
 *   - Wake windows, nap counts and day/night splits: the consistent middle of
 *     published parenting charts (Huckleberry, Little Ones, Baby Sleep Site)
 *     cross-checked against NHS guidance.
 *
